...
while [ $ix -le $iend1 ]; do
  ...
  file=rrfs.t00z.natlevf${i2}.tm00.grib2
   ...
   if [ $i2 -eq $istart1 ]; then
     wgrib2 $postdirx06/$file -match ":$field1" -match ":$field3" -GRIB $fname1
     wgrib2 $postdirx06/$file -match ":$field2" -match ":$field3" -GRIB $fname1s
   else
...
while [ $ix -le $iend2 ]; do
  ...
  file=rrfs.t18z.natlevf${i2}.tm00.grib2
   ...
   if [ $i2 -eq $istart2 ]; then
     wgrib2 $postdirx12/$file -match ":$field2" -match ":$field3" -GRIB $fname1x
   else
